...
/**
 * Created by -- on 17.02.2020.
 */
public class UniqueKmersFinder extends Tool {

    public static final String NAME = "unique-kmers";

    public static final String DESCRIPTION = "Output k-mers present in one dataset and missing in other";
    ...
    protected void runImpl() throws ExecutionFailedException, IOException {
        ...
        File outFile = new File(outDir, "filtered.kmers.bin");
        File stFile = new File(stDir, "filtered.stat.txt");
    ...
    public UniqueKmersFinder() {
        super(NAME, DESCRIPTION);
    }

    public static void main(String[] args) {
        new UniqueKmersFinder().mainImpl(args);
    }
