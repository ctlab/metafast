...
import algo.DeepComponentsBuilderAroundPivot;
import io.IOUtils;
...
public class DeepComponentExtractorMain extends Tool {
    ...
    protected void runImpl() throws ExecutionFailedException, IOException {
        ...
        try {
            ...
            components = DeepComponentsBuilderAroundPivot.splitStrategy(hm, k.get(), depth.get(), pivot, statFP, logger);
